...
[_LOWER] = LAYOUT_ortho_4x12( \
  ...
  SCN_LCK, _______, _______, _______, _______, _______, _______, _______, KC_P0, KC_PDOT, SPOT,    CHROME
),
...
[_RAISE] = LAYOUT_ortho_4x12( \
  ...
  _______, LOGW,    TEAMS,   SLACK,   TERM,    OUTLOOK, KC_EQL,  KC_MINS, KC_BSLS, KC_LBRC, KC_RBRC, KC_GRV,  \
